  ...
  return (
    <div className="min-h-screen bg-canvas">
      ...
      <div className="w-full flex flex-col pt-16">
        ...
        {/* ------------------------------------------------------- */}
        {/* Full-width Hero Section -- intro, CTAs, the globe  */}
        {/* ------------------------------------------------------- */}
        <section className="w-full bg-hero-gradient text-white py-16 md:py-24">
          <div className="max-w-6xl mx-auto px-4 md:px-8">
            <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-8">
              
              {/* Left Side: Text and CTAs */}
              <div className="w-full lg:w-1/2 flex flex-col items-center lg:items-start text-center lg:text-left">
                <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-2 leading-[1.15] tracking-tight">
                  F2F Cross-Border
                </h1>
                <p className="text-2xl sm:text-3xl font-semibold mb-6 tracking-tight">
                  <span className="gradient-text font-script text-4xl sm:text-5xl lg:text-6xl">Fiat-to-Fiat</span>{' '}
                  <span className="text-white/70 text-xl sm:text-2xl block lg:inline-block mt-2 lg:mt-0">Settlement Platform</span>
                </p>

                <p className="text-white/60 mb-10 leading-relaxed max-w-xl text-lg">
                ...
                <div className="flex flex-wrap justify-center lg:justify-start gap-4 mb-10 w-full max-w-lg">
                  <Link
                    to="/send-money"
                    className="flex items-center justify-center gap-2.5 rounded-full bg-white hover:bg-gray-100 text-[#1a1530] font-semibold text-base py-3 px-6 transition-all duration-300 shadow-[0_4px_20px_rgba(255,255,255,0.15)] hover:-translate-y-1 whitespace-nowrap"
                  >
                    <SendHorizonal className="w-4 h-4 text-brand-500" aria-hidden="true" />
                    Start Onboarding
                  </Link>
                  <Link
                    to="/track"
                    className="flex items-center justify-center gap-2.5 rounded-full bg-white/10 hover:bg-white/20 text-white font-semibold text-base py-3 px-6 transition-all duration-300 border border-white/20 hover:-translate-y-1 whitespace-nowrap"
                  >
                  ...
                  <Link
                    to="/app"
                    className="w-full flex items-center justify-center lg:justify-start gap-2 text-sm font-medium text-white/50 hover:text-white/80 transition-colors py-2 mt-2 lg:pl-2"
                  >
              ...
              <div className="w-full lg:w-1/2 flex justify-center lg:justify-end">
                <StyledGlobe size={320} />
              </div>

            </div>

            <div className="grid grid-cols-3 gap-8 pt-12 mt-4 border-t border-white/10 max-w-4xl mx-auto w-full">
              {stats.slice(0, 3).map((stat) => (
                <div key={stat.label} className="text-center">
                  <p className="font-mono text-3xl font-bold gradient-text tracking-tight mb-2">{stat.value}</p>
          ...
          <FadeSection as="section" className="py-16 md:py-24">
            <div className="container-app">
              <div className="relative bg-[#0a1428] rounded-[2rem] overflow-hidden p-10 md:p-14">
                ...
                <a
                  href="https://github.com/m0hammadusman/Cross-Border-Payments/blob/main/docs/legal/regulator-oversight.md"
                  target="_blank"
                  rel="noreferrer"
